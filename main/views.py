...
from Rest_API.models import DataStock, Index, SubIndex, TopGainers, TopLoosers, TopTurnOvers, TopTradedShares, DatewiseIndex
...
def index(request):
    f_index = Index.objects.all()
    f_SubIndex = SubIndex.objects.all()
    f_TopGainers = TopGainers.objects.all()
    f_TopLoosers = TopLoosers.objects.all()
    f_TopTurnOvers = TopTurnOvers.objects.all()
    f_TopTradedShares = TopTradedShares.objects.all()
    f_DatewiseIndex = DatewiseIndex.objects.all()
    ...
    return render(request, 'index.html', {
        'f_index': f_index,
        'f_subindex': f_SubIndex,
        'f_TopGainers': f_TopGainers,
        'f_TopLoosers': f_TopLoosers,
        'f_TopTurnOvers': f_TopTurnOvers,
        'f_TopTradedShares': f_TopTradedShares,
        'f_DatewiseIndex': f_DatewiseIndex,
    })
